...
def prep_data():
    ...
    train_dataset.save_to_disk("/home/ubuntu/mistral-finetune/mistral_finetune/data/chai_duduk/train")
    eval_dataset.save_to_disk("/home/ubuntu/mistral-finetune/mistral_finetune/data/chai_duduk/eval")
